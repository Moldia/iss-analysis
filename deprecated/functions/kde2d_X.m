function [bandwidth,density,X,Y]=kde2d_X(data,n,MIN_XY,MAX_XY,bandwid)
% modified by Xiaoyan, 2014-12-13
%
...
try
    ...
    warning('The data failed to sample the underlying distribution.');
    bandwidth = [bandwid(1),bandwid(2)];
    density = zeros(n);
...
if nargin>4
    t_x = (bandwid(1)/scaling(1))^2;
    t_y = (bandwid(2)/scaling(2))^2;
else
