function  Decoding_Sequencing_blank(input_file,num_hybs,taglist,grouped_YN,...
...
for t=1:num_tiles
    ...
    if temp_tile_num_blobs
        ...
        maxidx(maxint<0.0015) = 5;
        maxint(maxint<0.0015) = temp_tile_general(maxint<0.0015);
