function    Plotting_global_Sequencing(output_directory_decode,...
    output_filename_afterQT_prefix,background_image,resize_factor,...
    num_hybs,cycle5_empty_YN,abnormal_sequencing_YN,sequencing_order,...
    taglist_plot,use_old_style_YN,use_default_symbol_list_YN,symbol_size,...
    plot_reads_beforeQT_YN,~,~,exclude_NNNN_YN,...
    plot_based_on_group_YN,varargin)
...
%
% Plotting_global_Sequencing v2.4.2
% Xiaoyan, 2015-7-14
...
switch length(varargin)
    case 0
        ...
        plot_on_blank = 0;
    case 1
        plot_base1_general_stain = varargin{1};
        plot_on_blank = 0;
    case 2
        plot_base1_general_stain = varargin{1};
        plot_on_blank = varargin{2};
end
...
[taglist,expected_list,~,~,exp_tags,exp_groups] =  ...
    maketag(taglist_plot,num_hybs,cycle5_empty_YN,use_old_style_YN,...
